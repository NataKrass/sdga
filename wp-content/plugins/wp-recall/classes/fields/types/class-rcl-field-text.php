...
class Rcl_Field_Text extends Rcl_Field_Abstract {
	...
	function get_value() {
		...
		if ( $this->type == 'url' )
			// return '<a class="video" rel="nofollow" target="_blank" href="' . $this->value . '">' . $this->value . '</a>';
            return '<iframe width="640" height="360" src="' . $this->value . '" frameborder="0" allowfullscreen></iframe>';
		return $this->value;
	}
