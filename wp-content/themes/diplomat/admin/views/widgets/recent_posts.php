...
<div class="widget widget_recent_posts">
    ...
    <?php
    $def_array = array(
        'popular'  => esc_html__( 'Popular', 'diplomat' ),
        'latest'   => esc_html__( 'Latest', 'diplomat' ),
        'comments' => esc_html__( 'Comments', 'diplomat' )
    );

    $tabs_array = (($instance['category'] && count($instance['category'])) != 0) ? $instance['category'] : $def_array;
	...
	<?php foreach ($tabs_array as $key => $value){ ?>
        ...
        <div class="tab-content">
            ...
            <?php
            $args = array();
             if (($instance['category'] && count($instance['category'])) == 0){
