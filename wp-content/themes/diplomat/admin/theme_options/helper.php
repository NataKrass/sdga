...
class TMM_OptionsHelper {
	...
	public static function get_theme_buttons() {
		return array(
			'default' => esc_html__('Default White', 'diplomat'),
			'default-blue' => esc_html__('Default Blue', 'diplomat')
		);
	}

	public static function get_theme_buttons_sizes() {
		return array(
			'small' => esc_html__('Small', 'diplomat'),
			'middle' => esc_html__('Middle', 'diplomat'),
			'large' => esc_html__('Large', 'diplomat'),
		);
	}
	...
	public static function get_contacts_placeholder_icons() {
		return array(
			'' => "",
			'message-form-name' => esc_html__('Name', 'diplomat'),
			'message-form-email' => esc_html__('Email', 'diplomat'),
			'message-form-url' => esc_html__('URL', 'diplomat'),
			'message-form-message' => esc_html__('Message', 'diplomat')
		);
	}
